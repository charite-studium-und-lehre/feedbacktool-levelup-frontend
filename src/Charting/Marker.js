...
const Marker = props =>
    <g className={`${css.marker} ${props.extended ? css.selected : ''}`}>
        ...
        <g className={css.lines}>
            <AnimatedPath d={[[props.xScale(props.x), props.yScale(props.y)],[props.xScale(props.x), props.yScale(props.yScale.domain()[0])]]} stroke={props.color || COLORS.default} />
            ...
            <AnimatedPath d={[[props.xScale(props.xScale.domain()[0]), props.yScale(props.y)],[props.xScale(props.x), props.yScale(props.y)]]} stroke={props.color || COLORS.default} />
