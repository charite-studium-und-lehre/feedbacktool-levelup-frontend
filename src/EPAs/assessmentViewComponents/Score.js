...
const Score = ({t, values, externalScore, l, levelUpDone, levelUpConfident, levelDownDone, levelDownConfident, entryId, entry, headings, ...props}) => {
    ...
    return <div>
        <div className="row text-center container-fluid flex-wrap justify-content-between">
            {[t('Habe ich gemacht'), t('Traue ich mir zu')].map((l, i) =>
                <div key={i} className="col pb-0 px-2 pt-2" style={{color: colors[i]}}>
                    <Numbers
            ...
            <div className="col p-0 pt-2" style={{color: colors[2]}}>
                <Numbers
