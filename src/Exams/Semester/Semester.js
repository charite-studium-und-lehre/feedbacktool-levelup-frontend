...
const Semester = ({ match }) => {
        ...
        <div className="container-fluid">
            ...
            <div className="row mt-3">
                <div className="col">
                    <Details semester={match.params.test.split(".")[0]} result={result} data={_.zip(...data).map((d, i) => ({module: i+1, data: d, mean: _.mean(d)}))} totalMean={_.round(_.mean(data.map(d => _.mean(d))))} />
                </div>
            </div>
            <div className="row mt-3">
                <div className="col">
