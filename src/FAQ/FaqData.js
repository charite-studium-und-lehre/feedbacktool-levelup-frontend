...
},
{
    ...
    answer: 'Möglicherweise handelt es sich um einen Importfehler. Bitte kontaktiere in diesem Fall den Support unter "levelup@charite.de".'
},
{
    question: 'Ich kann mich mit meinen Charité-Logindaten im LevelUp nicht anmelden/registrieren.',
    answer: 'Bist Du aktuell im MSM 2.0 immatrikuliert? Wenn ja, kontaktieren Sie den Support unter "levelup@charite.de".'
}
