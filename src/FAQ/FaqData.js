...
const FaqData = [
    {
        question: 'Was ist LevelUp und wofür brauche ich das Tool?',
        answer: 'LevelUp ist ein neues Tool für alle Studierenden im MSM 2.0 an der Charité. Du siehst hier sämtliche Prüfungsergebnisse und deinen Lernfortschritt im Studium. Es zeigt deine MC-Prüfungsergebnisse bis ins Detail, inkl. Fragen, Antworten und Lösungen. Die praktischen ärztlichen Tätigkeiten (EPAs), die im Studium gelernt werden, werden hier dokumentiert und bewertet, sowohl durch dich selbst, als auch deine Dozierenden. Du kannst außerdem deinen Wissenszuwachs anhand des PTM-Features verfolgen. Dein Wissen wird auch nach Fachgebiet gerankt und du siehst wo aktuell deine Stärken sind, und wo du noch üben musst.'
    },
    {
