...
const Subjects = _.compose([needsData(selectors.loaded, actions.load), connect(selectors.getData)])( ({ data, flash }) => {
    const categories = _.groupBy( s => s.ptm ? s.ptm.kategorie : 'Andere' , data)
