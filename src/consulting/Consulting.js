                    ...
                    <div className='col-10 mx-auto'>
                        <div className='row mx-auto'>
                            ...
                            <div className="col-lg-6 col-sm-6 consulting-text pt-5 pl-4 mb-5">
                                <p>{t(`Du brauchst professionellen Rat zu den diversen Themen des Studienalltags?Damit du immer gut informiert bist, wer dir in der jeweiligen Situation weiterhelfen kann, sind hier einige hilfreiche Beratungsangebote der Charitè zusammengefasst. Falls du dringend Unterstützung für eventuelle Probleme im Studium benötigst, dann wende dich direkt per Mail an`)}:
