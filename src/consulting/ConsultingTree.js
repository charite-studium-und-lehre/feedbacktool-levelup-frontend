...
export const ConsultingTree = {
    ...
    },
   {
        ...
        name2:"Marta Gogluska-Obirek(Erasmus outgoing Students)",
        name3:"Angelika Cernitori (Eramus incoming students)",
   ...
   },
   {
        ...
        name2:"Leonie Kühn und Emma Kula (Organisation)",
   ...
   },
   {
        ...
        name2:"Sekretariat: Stefanie Schmidt ",
   ...
   },
   {
    ...
    name1:"Stella Berboth, Theodor Kempe",
